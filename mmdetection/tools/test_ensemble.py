...
from mmdet.models.detectors.htc_ensemble import HybridTaskCascadeEnsemble, HybridTaskCascadeEnsemble2

def parse_args():
    parser = argparse.ArgumentParser(
        description='MMDet test (and eval) a model')
    parser.add_argument('--configs', nargs='+', help='test config files')
    parser.add_argument('--checkpoints', nargs='+', help='checkpoint files')
    parser.add_argument('--out', help='output result file in pickle format')
    parser.add_argument('--data-phase', choices=('test_val', 'test', 'val_mini'), default='test')
    parser.add_argument(
        '--fuse-conv-bn',
        action='store_true',
...
def main():
    ...
    if samples_per_gpu > 1:
        ...
        primary_cfg.data.test.pipeline = replace_ImageToTensor(primary_cfg.data.test.pipeline)
    ...
    for i, cfg in enumerate(config_list):
        ...
        checkpoint = load_checkpoint(model, args.checkpoints[i], map_location='cpu')
